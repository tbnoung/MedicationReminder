...
@Injectable()
export class BeforedinnerProvider {
  Domainname:string;
  NameProvider:string;
  timeS:string;
...
// /*
//   Generated class for the BeforedinnerProvider provider.
...
//     console.log('Hello BeforedinnerProvider Provider');
//   }
