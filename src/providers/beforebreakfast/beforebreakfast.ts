...
@Injectable()
export class BeforebreakfastProvider {
  Domainname:string;
  NameProvider:string;
  timeS:string;
...
// /*
//   Generated class for the BeforebreakfastProvider provider.
...
//     console.log('Hello BeforebreakfastProvider Provider');
//   }
