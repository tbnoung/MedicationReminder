...
@Injectable()
export class AfterdinnerProvider {
  Domainname:string;
  NameProvider:string;
  timeS:string;
...
// /*
//   Generated class for the AfterdinnerProvider provider.
...
//     console.log('Hello AfterdinnerProvider Provider');
//   }
