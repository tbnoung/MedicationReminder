...
@Injectable()
export class AfterlunchProvider {
  Domainname:string;
  NameProvider:string;
  timeS:string;
...
// /*
//   Generated class for the AfterlunchProvider provider.
...
//     console.log('Hello AfterlunchProvider Provider');
//   }
