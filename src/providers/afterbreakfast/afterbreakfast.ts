...
@Injectable()
export class AfterbreakfastProvider {
  Domainname:string;
  NameProvider:string;
  timeS:string;
  ...
  dologin(nameP:string){
    return new Promise((resolve,reject)=>{
      ...
      var test = "monmon";
      let body = {Afterbreakfast:nameP};
      // this.http.put('http://5f5f649.ngrok.io/api/'+this.Domainname,'{'+this.NameProvider+':'+this.timeS+'}',options)
...
// /*
//   Generated class for the AfterbreakfastProvider provider.
...
//     console.log('Hello AfterbreakfastProvider Provider');
//   }
