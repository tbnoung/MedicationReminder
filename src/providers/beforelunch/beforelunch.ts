...
@Injectable()
export class BeforelunchProvider{
  Domainname:string;
  NameProvider:string;
  timeS:string;
...
// /*
//   Generated class for the BeforelunchProvider provider.
...
//     console.log('Hello BeforelunchProvider Provider');
//   }
